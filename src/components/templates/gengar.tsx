...
export const Gengar = ({ data }: TemplateProps) => {
  ...
  return (
    ...
    >
      <div
        className="max-w-[850px] w-full p-8 bg-gray-900 text-white shadow-lg"
        style={{
          padding: '40px',
      ...
      >
        {/* Header with Dark Style */}
        <header className="mb-8 text-center border-b-2 border-purple-500 pb-6">

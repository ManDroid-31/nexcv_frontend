...
export const Chikorita = ({ data }: TemplateProps) => {
  ...
  return (
    ...
    >
      ...
      >
        ...
        <header className="mb-8 text-center border-b-2 border-green-600 pb-6">
        ...
        {data.summary && (
          <section className="mb-8">
            <h2 className="text-2xl font-bold mb-4 text-green-700 border-b-2 border-green-200 pb-2">Research Summary</h2>
        ...
        {data.experience && data.experience.length > 0 && (
          <section className="mb-8">
            <h2 className="text-2xl font-bold mb-4 text-green-700 border-b-2 border-green-200 pb-2">Research Experience</h2>
            <div className="space-y-6">
              {data.experience.map((exp) => (
                <div key={exp.id} className="border-l-4 border-green-400 pl-4">
          ...
          <section className="mb-8">
            ...
            <div className="space-y-4">
              {data.education.map((edu) => (
                <div key={edu.id} className="border-l-4 border-green-400 pl-4">
        ...
        {data.skills && data.skills.length > 0 && (
          <section className="mb-8">
            <h2 className="text-2xl font-bold mb-4 text-green-700 border-b-2 border-green-200 pb-2">Research Skills</h2>
        ...
        {data.projects && data.projects.length > 0 && (
          <section className="mb-8">
            <h2 className="text-2xl font-bold mb-4 text-green-700 border-b-2 border-green-200 pb-2">Research Projects</h2>
            <div className="space-y-6">
